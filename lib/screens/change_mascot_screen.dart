              ...
              child: ListView(
                children: [
                  ...
                  CircleAvatar(
                    ...
                    child: IconButton(
                      icon:
                          Image.asset('assets/illustrations/mascot_1_bare.png'),
                      iconSize: iconSize,
                      onPressed: () {
                        vm.selectedMascot = "1";
                      },
                  ...
                  CircleAvatar(
                    ...
                    child: IconButton(
                      icon:
                          Image.asset('assets/illustrations/mascot_2_bare.png'),
                      iconSize: iconSize,
                      onPressed: () {
                        vm.selectedMascot = "2";
                      },
                  ...
                  CircleAvatar(
                    ...
                    child: IconButton(
                      color: vm.selectedMascot == "3"
                          ...
                          : Colors.transparent,
                      icon:
                          Image.asset('assets/illustrations/mascot_3_bare.png'),
                      iconSize: 180,
                      onPressed: () {
                        vm.selectedMascot = "3";
                      },
